...
wire PCUpdate, isFlush, isStall, memtoreg, memread, memwrite, RegWrite, ALUSrcA, isWWD, isHalt, isLWD;          
...
always @(posedge Clk) begin
  if(~Reset_N) begin
    ...
    if(~isFirst & (!isStall) & (!isFlush)) count <= count + 1;    // only increment for the used instrctions
